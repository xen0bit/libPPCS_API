...
int64_t cs2p2p_PPPP_Proto_Send_SSDP2PReq(char* arg1, int32_t arg2, sockaddr_in* arg3, char* arg4, int32_t arg5, char* arg6, int16_t* arg7)

{
    int0_t tpidr_el0;
    uint64_t x26 = _ReadStatusReg(tpidr_el0);
    int64_t x8 = *(x26 + 0x28);
    int32_t var_168 = 0x24003cf1;
    int64_t var_164;
    ...
    *var_154[6] = (_byteswap(arg7[1]) >> 0x10);
    ...
    int128_t v0;
    int128_t v1;
    v0 = cs2p2p__P2P_Proprietary_Encrypt("SSD@cs2-network.", &var_164, &var_268, 0x24);
    int32_t var_248;
    int32_t var_144 = var_248;
    int128_t var_258;
    var_154 = var_258;
    var_164 = var_268;
