...
int64_t cs2p2p_PPPP_Proto_Send_RSLgn(char* arg1, int32_t arg2, sockaddr_in* arg3, char* arg4, int32_t arg5, char* arg6, int32_t arg7, int32_t arg8)

{
    int0_t tpidr_el0;
    uint64_t x26 = _ReadStatusReg(tpidr_el0);
    int64_t x8 = *(x26 + 0x28);
    int32_t var_168 = 0x1c0060f1;
    int64_t var_164;
