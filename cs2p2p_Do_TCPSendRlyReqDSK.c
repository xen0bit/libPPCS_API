...
void cs2p2p_Do_TCPSendRlyReqDSK(int32_t arg1)
            ...
            else
            {
                *(x25_1 + 0x4a) = (x8_2 + 1);
                ...
                label_15104:
                    ...
                    *(x25_1 + 8);
                    char* var_a8_1 = &var_88;
                    void* var_c0_1 = &var_80;
                    int32_t var_b0_1 = 0;
                    void* var_b8_1 = (x8 + 0x100);
