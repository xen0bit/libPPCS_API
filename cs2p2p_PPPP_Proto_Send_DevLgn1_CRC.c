...
int64_t cs2p2p_PPPP_Proto_Send_DevLgn1_CRC(char* arg1, int32_t arg2, sockaddr_in* arg3, char* arg4, int32_t arg5, char* arg6, char arg7, char* arg8, int16_t* arg9, uint8_t* arg10)

{
    int0_t tpidr_el0;
    uint64_t x28 = _ReadStatusReg(tpidr_el0);
    int64_t x8 = *(x28 + 0x28);
    int32_t var_168 = 0x2c0013f1;
    int64_t s;
