...
int64_t DO_APILicenseCheck_PPPP(char* arg1, int32_t arg2, char* arg3)
    ...
    do
    {
        ...
        if (i_4 >= 1)
        {
            ...
            do
            {
                ...
                i = i_3;
                i_3 -= 1;
                x17_1 = (((x9 + 1) + arg2) + *(APILicenseMatrix_PPPP + ((x17_1 + x3_1) % 0x19)));
            } while (i != 1);
        }
        ...
        do
        {
            i_1 = i_2;
            i_2 -= 1;
            x2_8 = (x17_1 % *(APILicenseMatrix_PPPP + (x17_1 % 0x19)));
            x17_1 = (x18_2 + x2_8);
            x18_2 += 1;
        } while (i_1 != 1);
